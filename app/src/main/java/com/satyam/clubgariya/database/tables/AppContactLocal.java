...
public class AppContactLocal {
    ...
    public AppContactLocal(){

    }

    public AppContactLocal(String mobileNumber, String displayName, String timestamp, String status, boolean isClubUser) {
