...
public class TransactionImageAdapter extends RecyclerView.Adapter<TransactionImageAdapter.ChatImageHolder> {
    ...
    public TransactionImageAdapter(Context context, Transaction transaction, TransactionImageAdapterCallback transactionImageAdapterCallback) {
        this.context = context;
        this.transaction=transaction;
        this.transactionImageAdapterCallback=transactionImageAdapterCallback;
        this.imageUrls = transaction.getTransMediaList();
        if(imageUrls.size()>=4){
            imageHeight=250;
            imageWidth=250;
        }else{
    ...
    public ChatImageHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.transaction_image_row, parent, false);
    ...
    public void onBindViewHolder(@NonNull ChatImageHolder holder, int position) {
        ...
        holder.textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                transactionImageAdapterCallback.onTransactionImageItemClick(transaction,position);
            }
        });
